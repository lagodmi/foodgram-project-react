# Generated by Django 5.0.1 on 2024-01-25 11:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\Z', 'Поле username не соответствует формату.')], verbose_name='Логин')),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('subscriber', 'subscriber')},
            },
        ),
    ]
